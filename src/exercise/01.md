...
- You can use a [spread in object literals](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax#spread_in_object_literals) to shallow-clone (or in other words, merge) in this way, rather than using `Object.assign()`. The 2nd extra credit showcases this in the `countReducer` function:
